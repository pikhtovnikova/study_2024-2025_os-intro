...
Скачиваю последнюю версию исполняемого файла hugo с расширением extended для своей операционной системы (рис. @fig:001).
...
Проверяю есть ли подключение между public и репозиторием pikhtovnikova.github.io, после чего отправляю изменения на глобальный репозиторий (рис. @fig:018).
